...
setLatestReview(reviewData?.slice(0,6));
  ...
  return (
    <div className='flex items-center justify-center flex-col'>
      <h1 className='px-[20px] mt-[30px] text-center md:text-[45px] text-[30px] font-semibold'>Real Review for Real Courses
        </h1>
        <span className='lg:w-[50%] md:w[80%] text-[15px] text-center mt-[30px] mb-[30px] px[20px]'>Discover how our Virtual Courses is tranforming learning experiences through real feedback from students and professionals worldwide</span>
